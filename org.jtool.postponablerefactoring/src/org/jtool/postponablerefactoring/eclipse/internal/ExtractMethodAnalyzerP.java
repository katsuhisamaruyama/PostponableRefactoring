...
public class ExtractMethodAnalyzerP extends CodeAnalyzer {
    ...
    private List<IVariableBinding> localReads;
    
    public ExtractMethodAnalyzerP(ICompilationUnit unit, Selection selection) throws CoreException {
    ...
    public List<IVariableBinding> getLocalReads() {
        return localReads;
    }
    ...
    public ITypeBinding[] getArgumentTypes() {
    ...
    private void computeExceptions() {
        fAllExceptions = ExceptionAnalyzerP.perform(getSelectedNodes());
    }
