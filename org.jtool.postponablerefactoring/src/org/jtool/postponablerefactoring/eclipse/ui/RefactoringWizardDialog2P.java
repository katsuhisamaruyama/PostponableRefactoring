...
public class RefactoringWizardDialog2P extends TrayDialog implements IWizardContainer {
    ...
    public RefactoringWizardDialog2P(Shell shell, RefactoringWizard wizard) {
        super(shell);
    ...
    private boolean showErrorDialog(ErrorWizardPage page) {
        RefactoringStatusDialogP dialog = new RefactoringStatusDialogP(getShell(), page,
                fWizard.internalShowBackButtonOnStatusDialog(InternalAPI.INSTANCE));
        dialog.setPostponableRefactoring(fWizard.getRefactoring());
        ...
        switch (dialog.open()) {
            ...
            case IDialogConstants.CANCEL_ID:
                cancelPressed();
                break;
            case PostponableRefactoringManager.POSTPONE_ID:
                cancelPressed();
                PostponableRefactoring postponableRefactoring = (PostponableRefactoring)fWizard.getRefactoring();
